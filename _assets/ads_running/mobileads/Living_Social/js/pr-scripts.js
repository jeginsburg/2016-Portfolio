...
function prInitAd(){
	...
	try{
		...
		document.getElementById('prf' + PRPID).style.marginLeft = '-490px';
		document.getElementById('prf' + PRPID).style.top = '174px';
	}catch(error){}
...
function prGetData(){
	var prYear = '2015';
	var prDate = new Date();
	var prMonth = prDate.getMonth() + 1;
	var prDay = prDate.getDate();
	var prHour = prDate.getHours();
	var prMinutes = prDate.getMinutes();
	console.log('date ' + prDate);
	console.log('month ' + prMonth);
	console.log('day ' + prDay);
	console.log('hour ' + prHour);
	console.log('minute ' + prMinutes);
	...
	prDealInfo.src = 'https://stripe-s.pointroll.com/api/data/get/152?category=' + prCategory + '&city=' + prCity + '&format=jsonp&fset=2&z=' + prYear + prMonth + prDay + prHour + prMinutes;
...
function Option1Answer(answer){
	...
	if(answer == 1){
		...
		document.getElementById('pr-vday-panel-answer1-1-box').style.background = 'url(images/adventurous-checked.png)';
		document.getElementById('pr-vday-panel-answer1-1-box').style.backgroundSize = 'contain';
		document.getElementById('pr-vday-panel-answer1-2-box').style.background = 'url(images/romantic-unchecked.png)';
		...
		document.getElementById('pr-vday-panel-answer1-1-box').style.background = 'url(images/adventurous-unchecked.png)';
		document.getElementById('pr-vday-panel-answer1-1-box').style.backgroundSize = 'contain';
		document.getElementById('pr-vday-panel-answer1-2-box').style.background = 'url(images/romantic-checked.png)';
		document.getElementById('pr-vday-panel-answer1-2-box').style.backgroundSize = 'contain';
...
function Option2Answer(answer){
	...
	if(answer == 1){
		...
		document.getElementById('pr-vday-panel-answer2-1-box').style.background = 'url(images/somethingnew-checked.png)';
		document.getElementById('pr-vday-panel-answer2-1-box').style.backgroundSize = 'contain';
		document.getElementById('pr-vday-panel-answer2-2-box').style.background = 'url(images/localgem-unchecked.png)';
		document.getElementById('pr-vday-panel-answer2-2-box').style.backgroundSize = 'contain';
		document.getElementById('pr-vday-panel-answer2-3-box').style.background = 'url(images/heartracing-unchecked.png)';
		document.getElementById('pr-vday-panel-answer2-3-box').style.backgroundSize = 'contain';
	}else if(answer == 2){
		try{prActivity(8);}catch(error){}
		
		prDateType = 'localgem';
		document.getElementById('pr-vday-panel-answer2-1-box').style.background = 'url(images/somethingnew-unchecked.png)';
		document.getElementById('pr-vday-panel-answer2-1-box').style.backgroundSize = 'contain';
		document.getElementById('pr-vday-panel-answer2-2-box').style.background = 'url(images/localgem-checked.png)';
		document.getElementById('pr-vday-panel-answer2-2-box').style.backgroundSize = 'contain';
		document.getElementById('pr-vday-panel-answer2-3-box').style.background = 'url(images/heartracing-unchecked.png)';
		document.getElementById('pr-vday-panel-answer2-3-box').style.backgroundSize = 'contain';
	}else if(answer == 3){
		...
		document.getElementById('pr-vday-panel-answer2-2-box').style.background = 'url(images/localgem-unchecked.png)';
		document.getElementById('pr-vday-panel-answer2-2-box').style.backgroundSize = 'contain';
		document.getElementById('pr-vday-panel-answer2-3-box').style.background = 'url(images/heartracing-check.png)';
		document.getElementById('pr-vday-panel-answer2-3-box').style.backgroundSize = 'contain';
	}	
}